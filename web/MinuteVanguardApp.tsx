...
function PetView(props: Readonly<{ state: MinuteVanguardState; onToggle: (petId: string, active: boolean) => void; onGacha: (count: 1 | 10) => void; onTrain: (petId: string) => void; onBuySnacks: () => void }>) {
